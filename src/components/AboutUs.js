  ...
  return (
    <div className="about-container">
      ...
      <p>
        ...
        spirit to reach ahead from our client’s expectation. Communicable
        success rate of either portals managed by Trippy is a live paradigm of
        our work excellence.{" "}
      </p>
      ...
      <h1>Our Vision</h1>
      <p>
        To sow the assets of your excellence services with customer-centric
